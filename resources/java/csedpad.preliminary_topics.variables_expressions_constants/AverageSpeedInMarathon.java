...
@goalDescription(Construct a program that calculates the average speed in miles per hour using the values stored in variables given and print the height in meters with 2 digits after the decimal point to the console.)
**/
public class AverageSpeedInMarathon {
    public static void main(String[] args) {
//Declare multiple constant variables
         // i.e 26 miles 285 yards
/**@helpDescription(The variable MILES_PER_MARATHON is declared as double type and initialized to 26.21875. final modifier is used to make MILES_PER_MARATHON a constant variable, immutable. Constant variables are assigned to a value exactly once and this value cannot be changed after the initialization. The constant variables have to be initialized to a value when they declared. By Java naming conventions for constants, upper case letters are used and words are separated with '_'.)**/
        final double MILES_PER_MARATHON = 26.21875;
/**@helpDescription(The variable SEC_PER_HR is declared as int type and initialized to 3600. final modifier is used to make SEC_PER_HR a constant variable, immutable. Constant variables are assigned to a value exactly once and this value cannot be changed after the initialization. The constant variables have to be initialized to a value when they declared. By Java naming conventions for constants, upper case letters are used and words are separated with '_'.)**/
        final int SEC_PER_HR = 3600;
/**@helpDescription(The variable SEC_PER_MIN is declared as int type and initialized to 60. final modifier is used to make SEC_PER_MIN a constant variable, immutable. Constant variables are assigned to a value exactly once and this value cannot be changed after the initialization. The constant variables have to be initialized to a value when they declared. By Java naming conventions for constants, upper case letters are used and words are separated with '_'.)**/
		final int SEC_PER_MIN = 60;

//Declare multiple variables to hold marathon run time.
        double runtimeHrs = 2.0;
        double runtimeMins = 8.0;
        double runtimeSecs = 44.0;

//Calculate average miles per hour speed using the constant variables.
/**@helpDescription(The values of MILES_PER_MARATHON,SEC_PER_MIN,SEC_PER_HR constant are accessed and used in multiplication, division and addition arithmetic operations.)**/
