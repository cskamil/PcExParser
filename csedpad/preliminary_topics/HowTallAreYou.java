...
public class HowTallAreYou {
    public static void main(String[] args) {
        /**
         * logical_step_1: Declare the conversion rate as a constant variable and declares a variable to hold hieght in feet value.
         * logical_step_details: Declares a double constant variable to store feet to meter conversion rate and a double variable for height in feet to be used to convert the given height in feet to meters. 
         * question_1: Which variables are declared in the following code block?
         * answer_1: FEET_TO_METERS and heightInFeet variables
         * question_2: Which variable is declared as constant?
         * answer_2: FEET_TO_METERS
         * question_3: How to undertand if a variable is a constant or not?
         * answer_3: The use of final modifier before the variable type keyword.
         */

         /**
         * stm_comment: The variable FEET_TO_METERS is declared as double type and initialized to 0.30479. final modifier is used to make FEET_TO_METERS a constant variable, immutable. 
        ...
        /**
         * logical_step_2: Calculate height in meters by using a constant variable.
         ...
         */
         ...
         /**
          * stm_comment: The value of FEET_TO_METERS constant is accessed and multiplied by the heightInFeet variable. The usage of a constant variable is the same with other variables.
          */
        double heightInMeters = heightInFeet * FEET_TO_METERS;

        /**
         * logical_step_3: Print the value of heigthInMeters to console using printf method.
         * logical_step_details: The calculated height in meters value is printed to the console output using printf method to print the decimal variable with exactly 3 digits after the decimal point.
         * question_1: Why printf method is used to print the value of the heightInMeters?
         ...
         *              Format specifiers are defined using %. Here, %.3f means that %.3f should be replaced with the heightInMeters value and exactly 3 digits should be printed after the decimal(.).
