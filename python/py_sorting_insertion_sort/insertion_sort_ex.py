'''
@goalDescription(Insertion sort works similarly to how one would sort a hand of cards: by choosing an element and searching through the rest of the array to determine its proper place. Construct a function that performs insertion sort in ascending order on the given list. )
@name(Insertion Sort)
'''
# Define the insertion sorting function that sorts the given list in an ascending order
...
'''@helpDescription(We call ins_sort() on the list we initialized. Because we want to print the list after it’s been sorted, we enclose the function call in a print statement.)'''
